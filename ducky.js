window.onload = function() {
  ...
  //   create.style.top = Math.random() * window.innerHeight + 'px';
  //   create.style.left = Math.random() * window.innerWidth + 'px';
  // }

  // 4. Try making the duck move to a different location every second (what did we use to do this several lines up??)
// function shotDown() {
//   create.classList.add('shot');
//   setTimeout(function () {
//     create.remove();
//     checkForWinner();
//   }
// }
//   function moveDuckEverySecond(duck) {    
//     let duckMove = setInterval(function () {
//       moveDuck(duck);
//     }, 1000);
...
// 	create.addEventListener('click', duckShot);
// };
